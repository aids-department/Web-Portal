      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3 mb-8">
          <div className="p-3 bg-ds-red-tint ">
            <Trophy className="w-6 h-6 text-ds-red" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-navy">Manage Leaderboards</h1>
            <p className="text-ds-ink-soft">Update and manage competition rankings</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-white p-4   border border-ds-edge">
            <div className="flex items-center gap-3">
              <Users className="w-5 h-5 text-ds-blue" />
              <div className="flex-1">
                <p className="text-sm text-ds-ink-soft">Total Participants</p>
                {isEditing ? (
                    <div className="flex items-center gap-2 mt-1">
                      <input
                          ...
                          className="w-20 px-2 py-1 border  text-lg font-bold outline-blue-500"
                          autoFocus
                      />
                      <button onClick={handleSave} className="p-1 bg-ds-blue-tint text-ds-blue  hover:bg-ds-blue-tint">
                        <Save size={18} />
                      </button>
                    </div>
                ) : (
                    <p
                        className="text-xl font-bold text-navy cursor-pointer hover:text-ds-blue"
          ...
          <div className="bg-white p-4   border border-ds-edge">
            <div className="flex items-center gap-3">
              <Award className="w-5 h-5 text-ds-blue" />
              <div>
                <p className="text-sm text-ds-ink-soft">Active Competitions</p>
        ...
        <div className="bg-white p-6   border border-ds-edge">
          <h2 className="text-lg font-semibold text-navy mb-6">Competition Leaderboards</h2>

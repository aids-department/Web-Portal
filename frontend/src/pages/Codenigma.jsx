  ...
  return (
    <div className="min-h-screen bg-white p-6 sm:p-8 md:p-12">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-center text-4xl sm:text-5xl font-bold mb-12 text-gray-900 bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">Codenigma — Top 10 (by Year)</h1>

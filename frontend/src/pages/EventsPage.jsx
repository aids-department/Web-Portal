...
const EventsPage = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-indigo-50 via-white to-purple-50 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/30 p-8 overflow-hidden min-h-[80vh]">
      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent mb-4 font-cursive">
            Events & Workshops
          </h1>
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-6">
            {displayedEvents.length === 0 ? (
              <div className="bg-white/70 backdrop-blur-md rounded-3xl p-12 text-center shadow-lg border border-white/40">

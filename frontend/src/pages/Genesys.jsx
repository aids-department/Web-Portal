  ...
  return (
    <div>
      <div className="mb-10 pb-6 border-b-2 border-navy">
        <span className="text-kicker tracking-kicker uppercase text-ds-red">Project expo</span>
        <h1 className="text-page-heading text-navy mt-2.5">Genesys — top 3 by year</h1>
      </div>

  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[190px_1fr] gap-5 border border-ds-edge p-4 bg-white">
      ...
      <div className="flex flex-col gap-2.5">
        ...
        {/* Winner Preview */}
        {event.winner && (
          <div className="flex items-center gap-2 text-ds-red text-label font-medium">
            <Trophy size={14} />
        ...
        <div className="mt-auto pt-3 border-t border-ds-row flex items-center justify-between gap-4">
          <div className="flex gap-6">
            ...
            {event.prizeAmount && (
              <span className="text-label text-ds-ink-faint">
                Prize <span className="font-medium text-ds-ink-soft tabular-nums">₹{event.prizeAmount}</span>
              </span>
            )}
          </div>
